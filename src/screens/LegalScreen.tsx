...
interface Props {
 ...
 checklistDoneIds?: string[]; // IDs de tramites marcados en el checklist
}

export function LegalScreen({ renta = false, tieneCarro = false, nombreUsuaria, monthlyIncome = 0, checklistDoneIds = [] }: Props) {
 ...
 tieneCarro,
 monthlyIncome,
 docsEnBoveda: documentos.map(d => d.nombre),
 tramitesCompletados: checklistDoneIds,
 }) }] },
 contents: [
 ...historial,
