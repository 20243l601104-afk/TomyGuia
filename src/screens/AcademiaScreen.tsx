...
const BIENVENIDA_KEY = 'tomy_academia_bienvenida_vista';
...
const QUIZ: Record<NivelId, {pregunta:string;opciones:string[];correcta:number}[]> = {
 ...
 2: [
 { pregunta: 'Un cafe diario de $45, ¿cuanto suma al ano?', opciones: ['$1,640', '$8,200', '$16,425', '$45,000'], correcta: 2 },
 { pregunta: 'Cancelas una suscripcion de $150 al mes. ¿Cuanto ahorras al ano?', opciones: ['$150', '$900', '$1,800', '$3,600'], correcta: 2 },
 { pregunta: '¿Cuales son gastos hormiga?', opciones: ['Renta mensual', 'Pequeños gastos diarios que suman mucho', 'El aguinaldo', 'La despensa semanal'], correcta: 1 },
 ],
 3: [
 { pregunta: 'Si ganas $10,000, ¿cuanto va a necesidades (50%)?', opciones: ['$2,000', '$3,000', '$5,000', '$7,000'], correcta: 2 },
 { pregunta: 'En la regla 50/30/20, ¿que va en el 20%?', opciones: ['Renta y servicios', 'Gustos y salidas', 'Ahorro y futuro', 'Comida y transporte'], correcta: 2 },
 { pregunta: '¿Quien creo la regla 50/30/20?', opciones: ['Carlos Slim', 'Elizabeth Warren', 'Warren Buffett', 'El gobierno mexicano'], correcta: 1 },
 ],
 4: [
 ...
 5: [
 { pregunta: '¿Por que es util hacer un presupuesto mensual?', opciones: ['Para gastar menos en todo', 'Para saber a donde va tu dinero y planear', 'Solo lo necesitan las personas ricas', 'Para impresionar al banco'], correcta: 1 },
 { pregunta: '¿Cual es la categoria mas importante a cubrir primero?', opciones: ['Gustos y entretenimiento', 'Ahorro e inversion', 'Necesidades basicas', 'Deudas de tarjeta'], correcta: 2 },
 { pregunta: 'Si tu renta sola es el 60% de tu sueldo, ¿que deberias hacer?', opciones: ['Ignorarlo, es normal', 'Buscar una vivienda mas economica o aumentar ingresos', 'Dejar de ahorrar', 'Pedir un credito'], correcta: 1 },
 ],
 6: [
 { pregunta: '¿Que diferencia a una deuda buena de una mala?', opciones: ['El monto que debes', 'Si genera mas valor del que cuesta', 'Si te la dio un banco grande', 'Si puedes pagarla en quincenas'], correcta: 1 },
 { pregunta: '¿Cual es un ejemplo de deuda BUENA?', opciones: ['Tarjeta para vacaciones', 'Credito para zapatos de marca', 'Prestamo para estudiar y mejorar ingresos', 'Credito de nomina para gustos'], correcta: 2 },
 { pregunta: '¿Que significa CAT en un credito?', opciones: ['Costo Anual Total', 'Cargo Adicional de Tasa', 'Control de Ahorro Total', 'Credito Anual de Tarjeta'], correcta: 0 },
 ],
 7: [
 ...
 9: [
 { pregunta: '¿Cual es la diferencia principal entre ahorrar e invertir?', opciones: ['No hay diferencia', 'Ahorrar guarda dinero, invertir lo hace crecer', 'Invertir es mas seguro que ahorrar', 'Solo las personas ricas pueden invertir'], correcta: 1 },
 { pregunta: '¿Desde cuanto puedes empezar a invertir en CETES?', opciones: ['$10,000', '$5,000', '$1,000', '$100'], correcta: 3 },
 { pregunta: '¿Que es el interes compuesto?', opciones: ['Un interes muy alto', 'Ganar intereses sobre tus intereses — el dinero crece solo', 'Una deuda complicada', 'Un tipo de cuenta bancaria'], correcta: 1 },
 ],
 10: [
 ...
 11: [
 { pregunta: '¿Que es el AFORE?', opciones: ['Una cuenta de ahorro normal', 'Tu fondo de ahorro para el retiro', 'Un seguro de gastos medicos', 'Un tipo de inversion de alto riesgo'], correcta: 1 },
 { pregunta: '¿Quien administra el dinero de tu AFORE?', opciones: ['El gobierno directamente', 'Tu empresa', 'Una administradora privada supervisada por la CONSAR', 'El IMSS'], correcta: 2 },
 { pregunta: '¿Puedes elegir tu AFORE?', opciones: ['No, la asigna tu empresa', 'No, la asigna el gobierno', 'Si, puedes escoger y cambiar de AFORE', 'Solo si ganas mas de $20,000'], correcta: 2 },
 ],
 12: [
...
export function AcademiaScreen({ onAddFlowers }: Props) {
 ...
 const [vista, setVista] = useState<VistaId>('mapa');
 ...
 const bienvenidaVista = await AsyncStorage.getItem(BIENVENIDA_KEY);
 if (!bienvenidaVista) {
 ...
 <TouchableOpacity style={s.bienvenidaBtn} onPress={async () => { await AsyncStorage.setItem(BIENVENIDA_KEY, 'true'); setMostrarBienvenida(false); setVista('mapa'); }}>
 ...
 <View style={[s.container, { paddingTop: ins.top }]}>
 <View style={s.header}>
 <TouchableOpacity onPress={async () => { await AsyncStorage.setItem(BIENVENIDA_KEY, 'true'); setVista('mapa'); setMostrarBienvenida(false); }}>
 ...
 onPress={async () => { await AsyncStorage.setItem(BIENVENIDA_KEY, 'true'); setVista('mapa'); setMostrarBienvenida(false); }}
 >
